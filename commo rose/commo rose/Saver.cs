...
namespace commo_rose
{
    static class Saver
    {
        ...
        public static void save_settings(CustomButton[] buttons)
        {
            //if (doc == null)
            //    return;
            //XmlNode list_of_actions, modifiers_node, ordinary_node;
            //XmlElement node, action_node, process_node;
            //XmlNode CustomButtons = doc.DocumentElement.SelectSingleNode("CustomButtons");
